...
var dashboard_1 = require("../service/dashboard");
var dashboardRoutes = function (app) {
    app.get("/products_in_orders_active/:id", Authorization_1.default, productsAnActive);
    app.get("/products_in_orders_closed/:id", Authorization_1.default, productsInClosed);
};
